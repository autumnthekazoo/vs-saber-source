	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				frames = tex;
				animation.addByPrefix('idle', 'SaberIdle', 24, false);
				animation.addByPrefix('singUP', 'SaberUp', 24, false);
				animation.addByPrefix('singRIGHT', 'SaberRight', 24, false);
				animation.addByPrefix('singDOWN', 'SaberDown', 24, false);
				animation.addByPrefix('singLEFT', 'SaberLeft', 24, false);
